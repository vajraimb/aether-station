...
Status: **PHYSICS PASS / CAPTURE-VALUE VALIDATION PASS / ONLINE CONTROL UNPROVEN (0/10) / STOP kNN-VALUE LINE / RESEARCH PHASE COMPLETE / OVERALL CONTROL TASK FAIL**

PR: **DRAFT / DO NOT MERGE**

AETHER Research Benchmark v1 — tag `archive/control-v2-final` @ `0d871b4`. See `docs/research-phase.md`. Benchmark surfaces: `src/sim/core.ts` (SimCore), `src/sim/arena.ts` (AgentArena), `outputs/ARTIFACTS.md` (ledger).
